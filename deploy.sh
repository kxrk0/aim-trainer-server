#!/bin/bash
# ===============================================
# AIM TRAINER PRO SERVER - VPS DEPLOYMENT
# ===============================================
...
echo -e "${BLUE}===============================================${NC}"
echo -e "${BLUE}  AIM TRAINER PRO SERVER - VPS DEPLOYMENT${NC}"
echo -e "${BLUE}===============================================${NC}"
...
if [ ! -f "$PROJECT_DIR/.env" ]; then
    ...
    print_warning "Please edit $PROJECT_DIR/.env with your actual values!"
fi
